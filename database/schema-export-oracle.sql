    ...
    create table process (
        ...
        modify_table number(1,0) not null,
        modify_filter varchar2(255 char),
        modify_geom number(1,0) not null,
        name varchar2(255 char),
        organization_id number(10,0),
